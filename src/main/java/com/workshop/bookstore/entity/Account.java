...
public class Account {
    ...
    private Collection<HoaDon> hoaDonsByUid_0;
    @OneToMany(mappedBy = "accountByUid")
    ...
    private Collection<NhaCungCap> nhaCungCapsByUid;
    @OneToMany(mappedBy = "accountByCapNhatBoi")
    private Collection<NhaCungCap> nhaCungCapsByUid_0;
    @OneToMany(mappedBy = "accountByUid")
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(uid, account.uid) && Objects.equals(username, account.username) && Objects.equals(password, account.password) && Objects.equals(trangThai, account.trangThai);
    }

    @Override
    public int hashCode() {
        return Objects.hash(uid, username, password, trangThai);
    }
    ...
    public Collection<HoaDon> getHoaDonsByUid_0() {
        return hoaDonsByUid_0;
    }

    public void setHoaDonsByUid_0(Collection<HoaDon> hoaDonsByUid_0) {
        this.hoaDonsByUid_0 = hoaDonsByUid_0;
    }
    ...
    public Collection<NhaCungCap> getNhaCungCapsByUid() {
        return nhaCungCapsByUid;
    }

    public void setNhaCungCapsByUid(Collection<NhaCungCap> nhaCungCapsByUid) {
        this.nhaCungCapsByUid = nhaCungCapsByUid;
    }

    public Collection<NhaCungCap> getNhaCungCapsByUid_0() {
        return nhaCungCapsByUid_0;
    }

    public void setNhaCungCapsByUid_0(Collection<NhaCungCap> nhaCungCapsByUid_0) {
        this.nhaCungCapsByUid_0 = nhaCungCapsByUid_0;
    }
